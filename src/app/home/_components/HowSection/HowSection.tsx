...
const steps = [
  ...
  },
  {
    ...
    text: 'По инструкции копируете токен со страницы сервиса. Пароль от аккаунта мы не спрашиваем и не храним',
  },
  {
    title: 'Пользуетесь',
 ...
 *
 *  На телефоне это вертикальный таймлайн с линией между номерами, на
 *  широком экране — ряд карточек с той же линией, но горизонтальной.
 *  Четыре одинаковые карточки столбиком читались как несвязанный
 *  список, хотя порядок здесь и есть главное содержание блока.
 */
