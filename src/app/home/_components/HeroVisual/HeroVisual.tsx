...
/** Разбор ключа, показанный вместо пустого места справа от заголовка.
 *
 *  На широком экране первый экран был текстом в левой половине и
 *  пустотой в правой. Картинка объясняет, что происходит после ввода
 *  кода, — то есть тот самый вопрос, ради которого страницу и открыли.
 */
