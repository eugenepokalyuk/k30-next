...
export const LoginView: FC = () => {
  ...
  return (
    <AuthCard
      title="Вход"
      description="Профиль показывает ваши покупки и статусы активации. Активировать ключ можно и без входа."
      footer={
        <>
          Не получается войти?{' '}
          <a
      ...
      <div className={classes.form}>
        {isLoginDisabled && (
          <Notice tone="error" title="Вход временно недоступен">
            Ни почта, ни бот сейчас не настроены — войти в профиль нечем.
            Напишите в поддержку: ключ активируется и без профиля.
          </Notice>
        )}
          ...
          <>
            ...
            {telegram.stage === 'needs_code' && (
              <Notice tone="info" title="Бот ждёт код из письма">
                ...
                Без этого шага к профилю можно было бы привязать чужой адрес.
              </Notice>
            )}
