...
/**
 *  Чем покупатель платит. Состав задаёт админка: половина способов
 *  мерчанту не подключена, и плитка, за которой стоит отказ, хуже
 *  отсутствующей — покупатель узнаёт о нём, уже уйдя с сайта
 */
