 ...
 *
 *  Обёртка, а не хук: разметку секций это оставляет серверной — внутрь
 *  приходит уже отрисованный на сервере children, клиентским становится
 *  только сам контейнер с анимацией.
 */
